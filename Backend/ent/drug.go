...
func (e DrugEdges) DrugsOrErr() ([]*Registerstore, error) {
	if e.loadedTypes[0] {
		return e.Drugs, nil
	}
...
// QueryDrugs queries the drugs edge of the Drug.
func (d *Drug) QueryDrugs() *RegisterstoreQuery {
	return (&DrugClient{config: d.config}).QueryDrugs(d)
}
